...
\NormalTok{    model_lst <-}\StringTok{ }\KeywordTok{berquist}\NormalTok{(tau, B0, ptd, msk)}
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (model }\OperatorTok{==}\StringTok{ "CapeCod"}\NormalTok{) \{}
\NormalTok{    model_lst <-}\StringTok{ }\KeywordTok{capecod}\NormalTok{(tau, B0, ptd, msk)}
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (model }\OperatorTok{==}\StringTok{ "Hoerl"}\NormalTok{) \{}
\NormalTok{    model_lst <-}\StringTok{ }\KeywordTok{hoerl}\NormalTok{(tau, B0, ptd, msk)}
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (model }\OperatorTok{==}\StringTok{ "Wright"}\NormalTok{) \{}
\NormalTok{    model_lst <-}\StringTok{ }\KeywordTok{wright}\NormalTok{(tau, B0, ptd, msk)}
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (model }\OperatorTok{==}\StringTok{ "Chain"}\NormalTok{) \{}
\NormalTok{    model_lst <-}\StringTok{ }\KeywordTok{chain}\NormalTok{(tau, B0, ptd, msk)}
\NormalTok{  \}}
\NormalTok{g.obj <-}\StringTok{ }\NormalTok{model_lst}\OperatorTok{$}\NormalTok{g.obj}
\NormalTok{g.grad <-}\StringTok{ }\NormalTok{model_lst}\OperatorTok{$}\NormalTok{g.grad}
\NormalTok{g.hess <-}\StringTok{ }\NormalTok{model_lst}\OperatorTok{$}\NormalTok{g.hess}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{E =}\StringTok{ }\KeywordTok{g.obj}\NormalTok{(a0)}
...
\NormalTok{mean =}\StringTok{ }\KeywordTok{g.obj}\NormalTok{(mle}\OperatorTok{$}\NormalTok{par[}\DecValTok{1}\OperatorTok{:}\NormalTok{npar])}
\NormalTok{var =}\StringTok{ }\KeywordTok{exp}\NormalTok{(}\OperatorTok{-}\KeywordTok{outer}\NormalTok{(logd[, }\DecValTok{1}\NormalTok{], }\KeywordTok{rep}\NormalTok{(mle}\OperatorTok{$}\NormalTok{par[npar }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{], }\DecValTok{10}\NormalTok{), }\StringTok{"-"}\NormalTok{)) }\OperatorTok{*}\StringTok{ }\NormalTok{(mean }\OperatorTok{^}
...
\NormalTok{g1 =}\StringTok{ }\KeywordTok{g.grad}\NormalTok{(mle}\OperatorTok{$}\NormalTok{par[}\DecValTok{1}\OperatorTok{:}\NormalTok{npar])}
\NormalTok{gg =}\StringTok{ }\KeywordTok{aperm}\NormalTok{(}\KeywordTok{array}\NormalTok{(g1, }\KeywordTok{c}\NormalTok{(npar, }\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{, npar)), }\KeywordTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{))}
\NormalTok{gg =}\StringTok{ }\NormalTok{gg }\OperatorTok{*}\StringTok{ }\KeywordTok{aperm}\NormalTok{(gg, }\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{4}\NormalTok{))}
\NormalTok{meanv =}\StringTok{ }\KeywordTok{aperm}\NormalTok{(}\KeywordTok{array}\NormalTok{(mean, }\KeywordTok{c}\NormalTok{(}\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{, npar)), }\KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{))}
...
\NormalTok{smsk =}\StringTok{ }\KeywordTok{aperm}\NormalTok{(}\KeywordTok{array}\NormalTok{(}\KeywordTok{c}\NormalTok{(msk), }\KeywordTok{c}\NormalTok{(}\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{, nsim)), }\KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{))}
\NormalTok{smsn =}\StringTok{ }\KeywordTok{aperm}\NormalTok{(}\KeywordTok{array}\NormalTok{(}\KeywordTok{c}\NormalTok{(msn), }\KeywordTok{c}\NormalTok{(}\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{, nsim)), }\KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{))}
...
\NormalTok{    esim =}\StringTok{ }\KeywordTok{g.obj}\NormalTok{(spar)}
...
\NormalTok{      spar[, }\KeywordTok{c}\NormalTok{(npar }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{)], }\KeywordTok{c}\NormalTok{(nsim, }\DecValTok{10}\NormalTok{)}
...
\NormalTok{    psim =}\StringTok{ }\KeywordTok{array}\NormalTok{(spar[, npar }\OperatorTok{+}\StringTok{ }\DecValTok{2}\NormalTok{], }\KeywordTok{c}\NormalTok{(nsim, }\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{))}
...
\NormalTok{    temp =}\StringTok{ }\KeywordTok{array}\NormalTok{(}\KeywordTok{rnorm}\NormalTok{(nsim }\OperatorTok{*}\StringTok{ }\DecValTok{10} \OperatorTok{*}\StringTok{ }\DecValTok{10}\NormalTok{, }\KeywordTok{c}\NormalTok{(esim), }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{c}\NormalTok{(vsim))), }\KeywordTok{c}\NormalTok{(nsim, }\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{))}
...
\NormalTok{                            dnom}
\NormalTok{                          ), }\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{mean }\OperatorTok{*}\StringTok{ }\OperatorTok{!}\NormalTok{msk),}
                          \KeywordTok{sqrt}\NormalTok{(}\KeywordTok{sum}\NormalTok{(}
                            \KeywordTok{matrix}\NormalTok{(}\KeywordTok{c}\NormalTok{(dnom), }\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{) }\OperatorTok{^}\StringTok{ }\DecValTok{2} \OperatorTok{*}\StringTok{ }\NormalTok{var }\OperatorTok{*}\StringTok{ }\OperatorTok{!}\NormalTok{msk}
\NormalTok{                          ))))}
