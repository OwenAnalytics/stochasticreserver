...
```{r model-specific-code}
  ...
  if (model == "Berquist") {
    model_lst <- berquist(B0, paid_to_date, msk)
  } else if (model == "CapeCod") {
    model_lst <- capecod(B0, paid_to_date, msk)
  } else if (model == "Hoerl") {
    model_lst <- hoerl(B0, paid_to_date, msk)
  } else if (model == "Wright") {
    model_lst <- wright(B0, paid_to_date, msk)
  } else if (model == "Chain") {
    model_lst <- chain(B0, paid_to_date, msk)
  }
